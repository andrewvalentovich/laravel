    ...
    <div class="row flex-column py-5">
        ...
        <form action="{{ route('admin.articles.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('title') }}" type="text" name="title" class="form-control" id="articleTitle"
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('image') }}" type="text" name="image" class="form-control" id="articleImage"
